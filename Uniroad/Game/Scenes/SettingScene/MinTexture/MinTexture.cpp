...
*	@return なし
*/
void MinTexture::Initialize(CommonResources* resources, int width, int height)
{
	// 共通リソースをセット
...
/*
*	@brief 更新
*	@details 「MIN」テクスチャクラスの更新を行う
*	@param elapsedTime 経過時間
*	@return なし
*/
void MinTexture::Update(float elapsedTime)
{
	// 未使用警告非表示
...
/*
*	@brief 描画
*	@details 「MIN」テクスチャクラスの描画を行う
*	@param なし
*	@return なし
*/
void MinTexture::Render()
{
	// 画像を描画
