...
void Sheep::Initialize(CommonResources* commonResources)
{
	...
	//Attach(std::make_unique<MiniCharacterHead>(this, DirectX::SimpleMath::Vector3(0.0f, 1.0f, 0.0f), 0.0f));// 頭部を追加
	//Attach(std::make_unique<MiniCharacterHand>(this, DirectX::SimpleMath::Vector3(0.8f, 0.0f, 0.0f), 0.0f)); // 右手を追加
	//Attach(std::make_unique<MiniCharacterHand>(this, DirectX::SimpleMath::Vector3(-0.8f, 0.0f, 0.0f), 0.0f)); // 左手を追加
